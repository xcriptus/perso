...
exports.OperationCodaMap = exports.OperationsPluralLabel = exports.OperationLabel = exports.Operation = void 0;
...
exports.OperationLabel = 'Opération';
exports.OperationsPluralLabel = 'Opérations';
//-----------------------------------------------------------------------------
//     Code implementation
//-----------------------------------------------------------------------------
...
function getOperations() {
    return __awaiter(this, void 0, void 0, function* () {
        const rows = yield (0, coda_1.getTableRows)(CODA_TABLE_IMP_OPERATIONS_ID, exports.OperationLabel);
        return rows.map((row) => {
