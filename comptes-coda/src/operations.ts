...
// import { CODA_TABLE_IMP_OPERATIONS_ID } from './etiquette1'
...
export const OperationLabel = 'Opération'
export const OperationsPluralLabel = 'Opérations'

//-----------------------------------------------------------------------------
//     Code implementation
//-----------------------------------------------------------------------------

const CODA_TABLE_IMP_OPERATIONS_ID = process.env.CODA_TABLE_IMP_OPERATIONS_ID!
...
export async function getOperations(): Promise<Operation[]> {
    const rows = await getTableRows(CODA_TABLE_IMP_OPERATIONS_ID, OperationLabel)
    return rows.map((row: any) => {
        const values = row.values
        return new Operation(
            parseField(
                values[OperationCodaMap.code.code],
                OperationCodaMap.code
            ),
            parseField(
                values[OperationCodaMap._compte.code],
                OperationCodaMap._compte
            ),
            parseField(
                values[OperationCodaMap.mois.code],
                OperationCodaMap.mois
            ),
            parseField(
                values[OperationCodaMap.date_de_comptabilisation.code],
                OperationCodaMap.date_de_comptabilisation
            ),
            parseField(
                values[OperationCodaMap.date_operation.code],
                OperationCodaMap.date_operation
            ),
            parseField(
                values[OperationCodaMap.date_de_valeur.code],
                OperationCodaMap.date_de_valeur
            ),
            parseField(
                values[OperationCodaMap.montant.code],
                OperationCodaMap.montant
            ),
            parseField(
                values[OperationCodaMap.etiquette1.code],
                OperationCodaMap.etiquette1
            ),
            parseField(
                values[OperationCodaMap.type_particulier.code],
                OperationCodaMap.type_particulier
            ),
            parseField(
                values[OperationCodaMap.type.code],
                OperationCodaMap.type
            ),
            parseField(
                values[OperationCodaMap.info.code],
                OperationCodaMap.info
            ),
            parseField(
                values[OperationCodaMap.row_range.code],
                OperationCodaMap.row_range
            ),
            parseField(
                values[OperationCodaMap._type_operation.code],
                OperationCodaMap._type_operation
            )
        )
    })
}
