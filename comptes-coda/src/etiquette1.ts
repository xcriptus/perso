...
export async function getEtiquettes1(): Promise<Etiquette1[]> {
    const rows = await getTableRows(TABLE_TBL_ETIQUETTES1_ID);
    return rows.map((row: any) => {
        const values = row.values;
        return new Etiquette1(
            parseField(values[Etiquette1CodaMap.etiquette1.code], Etiquette1CodaMap.etiquette1),
            parseField(values[Etiquette1CodaMap.comptes.code], Etiquette1CodaMap.comptes),
            parseField(values[Etiquette1CodaMap.labels.code], Etiquette1CodaMap.labels),
            parseField(values[Etiquette1CodaMap.description.code], Etiquette1CodaMap.description),
            parseField(values[Etiquette1CodaMap.frequence.code], Etiquette1CodaMap.frequence),
            parseField(values[Etiquette1CodaMap.max.code], Etiquette1CodaMap.max),
            parseField(values[Etiquette1CodaMap.min.code], Etiquette1CodaMap.min),
            parseField(values[Etiquette1CodaMap.mois.code], Etiquette1CodaMap.mois)
        );
    });
}
